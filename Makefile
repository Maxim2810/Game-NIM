...
bin/game: repository  build/src/main.o build/src/menu.o build/src/game.o 
	$(BB) build/src/main.o build/src/menu.o build/src/game.o -o bin/game $(SFMLFIX)
build/src/main.o: src/main.c
	$(BB) -c -o build/src/main.o src/main.c $(SFMLFIX)
build/src/menu.o: src/menu.c
	$(BB) -c -o build/src/menu.o src/menu.c $(SFMLFIX)
build/src/game.o: src/game.c
	$(BB) -c -o build/src/game.o src/game.c $(SFMLFIX)
